...
<head>
    ...
    <link rel="stylesheet" href="estilo_funcionarios.css">
    <?php include '../../modulos/funcionarios/modal_cadastrar_funcionario.php'; ?>
    <?php include '../../modulos/funcionarios/modal_editar_funcionario.php'; ?>
    <?php include '../../modulos/funcionarios/modal_excluir_funcionario.php'; ?>
</head>
...
<body>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <form method="post" action="reativar_funcionario.php" style="display: inline;">
    ...
    <script src="js_funcionarios.js"></script>
</body>
