...
<head>
    ...
    <link rel="stylesheet" href="../login/estilo_login.css">
</head>
...
<body>
    <div class="login-container">
        ...
        <div id="form-cadastro-admin" class="formulario-login mt-4 d-none">
            <form action="cadastrar_admin.php" method="POST">
                ...
                <div class="row g-2">
                    <div class="col">
                        <button type="button" class="btn btn-outline-secondary w-100" onclick="voltarParaLoginAdmin()">Voltar</button>
                    </div>
                    <div class="col">
        ...
        <!-- Formulário login Colaborador -->
        <div id="form-colaborador" class="formulario-login mt-4 d-none">
            <form action="validar_funcionario.php" method="POST">
                <div class="mb-3">
    ...
    <script src="../login/js_login.js"></script>
